...
document.addEventListener("DOMContentLoaded", function () {
    document.querySelectorAll(".flip-button-more").forEach(function (button) {
        button.addEventListener("click", function (event) {
            event.preventDefault();
            let card = this.closest(".flip-card-container").querySelector(".flip-card");
            card.classList.add("flipped");
        });
    });

    document.querySelectorAll(".flip-button-back").forEach(function (button) {
...
$(document).ready(function(){
      // Rotacionar o card ao clicar no botão
      $("#rotateBtn").click(function(){
        $("#card").addClass("card-rotated");
      });

      // Voltar o card ao clicar no botão de voltar
      $("#resetBtn").click(function(){
        $("#card").removeClass("card-rotated");
      });
    });